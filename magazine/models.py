...
class BlogPost(models.Model):
    ...
    author = models.ForeignKey(User, on_delete = models.CASCADE,  default = 1,  blank = True, related_name = "author_posts")
...
class Comment(models.Model):
    ...
    comment_usr = models.ForeignKey(User, on_delete = models.CASCADE, blank = True, null = True, default = get_default_user, related_name = 'user_comments')
...
class comment_of_comment(models.Model):
    ...
    #body = RichTextField(blank = False, null = False, max_length = 10000)
    body = RichTextUploadingField(blank = False, null = False, max_length = 10000)
    comment_of_comment_usr = models.ForeignKey(User, on_delete = models.CASCADE, blank = True, null = True, default = get_default_user, related_name = 'user_sub_comments')
